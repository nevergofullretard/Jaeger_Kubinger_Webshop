...
namespace Jaeger_Kubinger_Webshop
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            MainMenu(new User("Max", "Kubinger", DateTime.Now, new Adress("Musterstraße",1, 1020,"Wien")), new Cart(), Webshop);

            // für Eingabe von Console das in Main Menu 1. Parameter kopieren:
